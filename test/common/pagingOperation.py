...
class PagingOperation(object):
    ...
    def __init__(self, driver):
        ...
        # 输入页数
        self.input = self.paging.find_element(By.CSS_SELECTOR, 'input')#input标签选择
...
if __name__ == '__main__':
    ...
    driver.get('file:///D:/autotest/AutoTestExample-master/projectHtml/chapter9/period4-5/index.html')
    sleep(3)
